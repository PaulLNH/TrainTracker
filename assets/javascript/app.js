        ...
        if (snapshot.exists()) {
            ...
            snapshot.forEach(function (data) {
                ...
                $("#trainTable").append(
                    ...
                    "</td><td>" +
                    tMinutesTillTrain +
                    ' min </td> <td><i class="fas fa-edit updateBtn" data-toggle="tooltip" data-placement="right" title="Edit"></i> <i class="fas fa-times-circle removeBtn" data-toggle="tooltip" data-placement="right" title="Remove"></i></td></tr>'
                );
            });
        }
    });
